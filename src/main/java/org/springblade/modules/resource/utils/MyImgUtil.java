...
public class MyImgUtil {
    public static final Logger log = LoggerFactory.getLogger(MyImgUtil.class);
    //压缩率
    public static final transient float IMAGE_RATIO = 0.1f;
    //压缩最大宽度
    public static final transient int IMAGE_WIDTH = 800;
    // 水印透明度
    public static float alpha = 0.3f;
    // 水印文字字体
    public static Font font = new Font("PingFang SC Regular", Font.PLAIN, 36);
    // 水印文字颜色
    public static Color color = new Color(111, 111, 111);
    //水印文字内容
    public static final String text = "这是一个水印文本";
    // 水印之间的间隔
    public static final int XMOVE = 80;
    // 水印之间的间隔
    public static final int YMOVE = 80;
