...
public class NumberUtil {
	...
	public static Integer toInteger(Object obj,Integer defaultValue){
		try {
			return Integer.parseInt(getNumbers(String.valueOf(obj)));
		} catch (Exception e) {
               return defaultValue;
		}
	}
	...
	public static Long getRandomNumber(int start,int length){
		String str="123456789";
		StringBuilder sb=new StringBuilder(length);
		for(int i=0;i<length;i++)
		{
		...
		return Long.valueOf(Integer.valueOf(start)+sb.toString());
	}
}
